...
class Admin::PostsControllerTest < ActionController::TestCase
  ...
  test "should create admin_post" do
    assert_difference('Admin::Post.count') do
      post :create, admin_post: { listing_company: @admin_post.listing_company, price: @admin_post.price, title: @admin_post.title, url: @admin_post.url }
    end
  ...
  test "should update admin_post" do
    patch :update, id: @admin_post, admin_post: { listing_company: @admin_post.listing_company, price: @admin_post.price, title: @admin_post.title, url: @admin_post.url }
    assert_redirected_to admin_post_path(assigns(:admin_post))
  end
